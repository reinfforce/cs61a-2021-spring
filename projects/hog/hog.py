...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    for i in range(1,11):
        ...
        scoring_num = k(i,dice)
        if scoring_num > max_scoring_num:
...
def hefty_hogs_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    point_gain_hh = hefty_hogs(score, opponent_score)
    if point_gain_hh >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    point_gain_hh = hefty_hogs(score, opponent_score)
    if (point_gain_hh) >= threshold or ((score + point_gain_hh) % 10 == opponent_score % 10 and opponent_score % 10 != 0):
        return 0
    else:
        return num_rolls 
    # END PROBLEM 11
